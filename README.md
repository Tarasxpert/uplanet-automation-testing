...
- To run a parallel ui.tests, run `mvn test -P sample-test`
- To run local ui.tests, run `mvn test -P sample-local-test`
- To run a full suite of ui.tests with Cross-browser Testing, run `mvn test -P suite`
